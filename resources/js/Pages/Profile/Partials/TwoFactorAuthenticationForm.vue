...
<template>
    <JetActionSection>
        ...
        <template #content>
            ...
            <h3 v-else-if="confirming" class="text-lg font-medium text-gray-900 dark:text-white">
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-white" v-if="setupKey">
